                    ...
                    <ul class="j_lzl_m_w" style="display:">
                        ...
                        <li class="lzl_single_post j_lzl_s_p first_no_border">
                            ...
                            <div class="j_user_card lzl_p_p" >
                              <img src="user<?php echo rand(0,$PHOTONUM);?>.jpg" style="opacity:0.2;height:32px;width:32px;"/>
                            </div>
                            <div class="lzl_cnt"> <span class="lzl_content_main">  
                            <span>&nbsp;&nbsp;</span><?php echo htmlspecialchars(c($LZL['content'])); ?>
                          </span> 
															<!--// <div class="lzl_content_reply"><span class="lzl_jb"></span><span class="lzl_op_list j_lzl_o_l" style=""><a href="#" class="j_lzl_ban">封</a>&nbsp;|&nbsp;<a href="#" class="j_lzl_del">删除</a>&nbsp;|&nbsp;</span><span class="lzl_time"><?php echo $LZL['timestamp']; ?></span> <a href="#" class="lzl_s_r">回复</a> </div> -->
                            </div>
                        </li>
                        <?php } ?>
